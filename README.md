...
>
> — @ Qubole (Nasdaq-listed big data platform) · multi-cloud production · enterprise SLAs with penalty clauses
...
| `4 yrs` production SRE | `$60K` cloud saved / year | `99.9%` SLO across 10+ services |
|:---:|:---:|:---:|
| `<20 min` MTTR achieved | `100+` Terraform resources | `65%` critical CVEs reduced |
...
![AWS](https://img.shields.io/badge/AWS_EKS-C4873A?style=flat&logoColor=fff&logo=amazonaws)
...
![HCL](https://img.shields.io/badge/HCL-1C1917?style=flat&logoColor=C4873A&logo=terraform)
...
Production-ready Terraform module for EKS with Fargate — VPC, node groups, IRSA, and RBAC wired up out of the box. Used by teams who don't want to start from scratch. Battle-tested at Qubole.

`HCL` · `Terraform` · `AWS EKS` · `Fargate` · `IRSA`
...
- RHCSA · 2022
- Red Hat Certified Specialist – Containers & Kubernetes · 2022
- **AWS Community Builder** · recognised for technical community contributions ◆

---

## Writing

DevOps, SRE war stories, cloud cost engineering, and infrastructure deep-dives on [Medium →](https://harshetjain.medium.com)
